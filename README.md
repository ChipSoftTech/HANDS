...
[HANDS](https://github.com/ChipSoftTech/HANDS) is a REST API Server for MongoDB built in node.js.

## About

The idea for HANDS was born when I needed a REST API for a large project and didn't have anyone to help create all the APIs 

So this is my attempt at building a small and easy to use REST API Server for MongoDB with primary focus on json. This is HANDS v2.  HANDS v1 was written in C# using SQL Server.


## Installation

### Clone with git
    git clone https://github.com/ChipSoftTech/HANDS.git

### NPM updated
	npm updated
	npm update -d
Note: -d is to pull down the packages for development (ie mocha)	
...
* Choose **false** to suppress output debug to standard output
	
#### Security	
* Choose **true** to enforce JSON Web Token authentication and authorization 
* Choose **false** for no security - !!!warning!!! only for dev since anyone can do CRUD
...
Apache License
Copyright (c) 2015 Chippewa Software Technology, LLC
   ...
   Copyright 2015 Chippewa Software Technology, LLC
