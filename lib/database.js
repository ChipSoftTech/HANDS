...
module.exports.database = {
	...
	update : function (channel, database, collection, id, createdby, updatedby, doc, callback) {
		this.read(channel, database, collection, id, createdby, null, null, function (err, currentDoc) {
			if (err) {
				return callback(err);
			}
